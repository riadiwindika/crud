...
@section('content')
    <div class="row">
        <div class="col-10">
            <h5>Buat Product</h5>
            <form action="{{ route('product.store') }}" method="post" class="mt-5" id="custom_form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="nama_barang">Nama Product</label>
                            <input type="text" name="name" id="nama_barang" value="{{ old('name') }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" id="harga_product" value="{{ old('price') }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="quantity" id="total_product" value="{{ old('quantity') }}" class="form-control">
                        </div>
                    </div>
                </div>
